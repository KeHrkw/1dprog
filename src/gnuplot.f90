...
write(10,*) 'set grid'
write(10,*) 'plot "./output/td.dat" u 2:3 w l title "n=0",\'
write(10,*) ' "./output/td.dat" u 2:4 w l title "n=Nbt" axes x1y2'
write(10,*) 'reset'
...
write(10,*) 'reset'
write(10,*) 'set output "./output/td_Elewave.eps"'
write(10,*) 'set ytics nomirror'
write(10,*) 'set y2tics         # 第二y軸を描画することを指定'
write(10,*) 'set xlabel "time"'
...
write(10,*) 'set grid'
write(10,*) 'plot "./output/td_V.dat" index 0 u 2:7 w l title "Et",\'
write(10,*) '     "./output/td_V.dat" index 0 u 2:8 w l title "At" axes x1y2'
write(10,*) 'reset'
write(10,*) 'set terminal postscript eps enhanced color'
...
write(10,*) 'set xrange[0:300]'
write(10,*) 'plot   "./output/integ.dat" index 0 u 2:4 w lp pt 2,\'
write(10,*) '	"./output/integ.dat" index 1 u 2:4 w lp pt 2'
write(10,*) 'reset'
if( isplot==1 )then
